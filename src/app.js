...
import CircleSquare from "./imagenes/CircleSquare.png";
import BootstrapIcons from "./imagenes/BootstrapIcons.png";
import BootstrapThemes from "./imagenes/BootstrapThemes.png";
import Gota from "./imagenes/Gota.png";
import './app.css'
        ...
        <>  
            ...
            <div className='Contenido'>
                ...
                <div className='Contenido8'>
                    <div className='Izquierda'>
                        ...
                        <Instalation clase={'Instalation2'} textclase={'Itext2'}
                            ...
                            <TextLink3 linked={'Read our installation docs'} normal={'for more info and additional package managers.'}></TextLink3>
                    </div>
                ...
                <div className='Contenido13'>
                    ...
                    <TextLink5 clase={'contTextOut'} firstText={'New in Bootstrap 5, our utilities are now generated by our'}
                ...
                <div className='Contenido17'>
                    <div className='Izquierda2'>
                        <Icon clase={'CircleSquare'} imgClase={'ImgCircleSquare'} src={CircleSquare}></Icon>
                        <Object clase={'Customize2'} text={'Personalize it with Bootstrap Icons'}></Object>
                        <TextLink3 linked={'Bootstrap Icons'} normal={"is an open source SVG icon library featuring over 1,800 glyphs, with more added every release. They're designed to work in any project, whether you use Bootstrap itself or not. Use them as SVGs or icon fonts—both options give you vector scaling and easy customization via CSS."}></TextLink3>
                        <div className='ContainerFlecha'>
                            <Object clase={'Instalationtext'} text={'Get Bootstrap Icons'}></Object>
                            <Object clase={'Instalationflecha'} text={'→'}></Object>
                        </div> 
                    </div>
                    <div className='Derecha2'>
                        <CreateImg clase={'BootstrapIcons'} src={BootstrapIcons}></CreateImg>
                    </div>
                </div>
                <div className='Contenido17'>
                    <div className='Izquierda2'>
                        <Icon clase={'Gota'} imgClase={'ImgGota'} src={Gota}></Icon>
                        <Object clase={'Customize3'} text={'Make it yours with official Bootstrap Themes'}></Object>
                        <TextLink5 clase={'contTextOut2'} firstText={'Take Bootstrap to the next level with premium themes from the'}
                        linkedText={'official Bootstrap Themes marketplace'}
                        secondText={'Themes are built on Bootstrap as their own extended frameworks, rich with new components and plugins, documentation, and powerful build tools.'}
                        ></TextLink5>
                        <div className='ContainerFlecha'>
                            <Object clase={'Instalationtext'} text={'Browse Bootstrap Themes'}></Object>
                            <Object clase={'Instalationflecha'} text={'→'}></Object>
                        </div> 
                    </div>
                    <div className='Derecha2'>
                        <CreateImg clase={'BootstrapThemes'} src={BootstrapThemes}></CreateImg>
                    </div>
                </div>
